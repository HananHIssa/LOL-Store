...
import { FaCartArrowDown, FaMinus, FaPlus, FaTrashAlt } from 'react-icons/fa';
...
export default function Cart() {
    ...
    const getCart = async () => {
      ...
      const incraseQuantity = async (productId) => {
        const add = await axios.patch(`https://ecommerce-node4-five.vercel.app/cart/incraseQuantity`, {
          productId
        }
          , {
            headers: {
      ...
      const decraseQuantity = async (productId) => {
        ...
        const dec = await axios.patch(`https://ecommerce-node4-five.vercel.app/cart/decraseQuantity`, {
          productId
        }
          , {
            headers: {
      ...
      const deleteProduct = async (productId) => {
        const deleteItem = await axios.patch(`https://ecommerce-node4-five.vercel.app/cart/removeItem`, {
          productId
        }
          , {
            headers: {
...
<div className='oneproduct' key={product.details._id}>
  ...
  <div key={product._id} style={{ textDecoration: 'none' }}>
